        ...
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden bg-indigo-700 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <h3 className="text-lg font-medium text-white">Don't be shy!</h3>
              <p className="mt-6 max-w-3xl text-base text-indigo-50">
                If you have a project in mind or would like to make an enquiry
                simply and If you think we’d be a good match send us an email!
              </p>
              ...
              <ul role="list" className="mt-8 flex space-x-12">
                <li>
                  <a
                    ...
                    href="https://m.me/goncalopereira1515"
                    target="blank"
                  >
                ...
                <li>
                  <a
                    className="text-indigo-200 hover:text-indigo-100"
                    href="https://api.whatsapp.com/send?phone=912220291&text=Hello, more information!"
                    target="blank"
                  >
